            ...
            <div class="modal-body">
                <form class="form-horizontal jqtransformdone">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" id="stupassword1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" id="stupassword2"
                                   placeholder="yourpassword">
                            <span class="help-block"></span>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="userPass" class="form-control" id="stupassword"
                                   placeholder="yourpassword">
                            <span class="help-block"></span>
                        </div>
                    </div>
...
<script>
    ...
    $("#user_save_btn").click(function () {
        ...
        $.ajax({
            url: "${staticPath}/v1/api/user/register",
            type: "POST",
            dataType: "json",
            data: arr,//序列化保存的数据
            success: function (result) {
...
//清除表单样式
    ...
    function getyzm(obj) {
        ...
        $.ajax({
            type: 'get',
            url: '${staticPath}v1/api/mail/sendYZM',
            dataType: "json",
            data: {"email": email},
            success: function (result) {
                if (result.resultCode == 20000) {
                    ...
                    function show() {
                        $.ajax({
                            type: 'get',
                            data: {"email": email},
                            url: '${staticPath}v1/api/mail/checkoutyzm',
                            dataType: "json",
                            success: function (result) {
                                if (result.resultCode == 20000) {
                                    yzmre('#mimayzm');
    ...
    $("#stu_change_btn").click(function () {
        ...
        if (!regY.test(mimayzm)) {
            show_validate_msg("#mimayzm", "error", "验证码格式错误，请重新输入！");
            return false;
        } else if (mimayzm == '') {
        ...
        $.ajax({
            url: "${staticPath}/v1/api/user/forgetPwd",
            type: "POST",
            dataType: "json",
            data: {"userEmail": email, "userPass": pwd2, "yzm": mimayzm},
            success: function (result) {
                console.log(result);
                if (result.resultCode === 20000) {
