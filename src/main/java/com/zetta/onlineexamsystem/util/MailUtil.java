package com.zetta.onlineexamsystem.util;
...
public class MailUtil {
    ...
    public void sendSimpleMail(String email, String subject, String context) {
        ...
        //发送邮件协议名称
        props.setProperty("mail.transport.protocol", mail.getProtocol());
        //设置环境
        Session session = Session.getInstance(props);
        try {
            //根据session得到transport对象
            Transport ts = session.getTransport();
            ts.connect(mail.getHost(), mail.getFrom(), mail.getPassword());
            //创建邮件
    ...
    private MimeMessage createSimpleMail(Session session, String email, String subject, String context) throws MessagingException {
        ...
        //先给自己抄送一份，解决554
        msg.addRecipients(Message.RecipientType.CC, String.valueOf(new InternetAddress(mail.getFrom())));
        //收件人
